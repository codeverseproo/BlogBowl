...
declare module '@tiptap/core' {
    interface Commands<ReturnType> {
        slashCommand: {
             ...
             */
            openGenericModal: (type: GenericModalUrlType) => ReturnType;
            /**
             * Close the generic modal
             */
            closeGenericModal: () => ReturnType;
        };
    }
}

type Storage = { type: GenericModalUrlType; isModalOpen: boolean; rect: any };

export const SlashCommand = Extension.create<Storage>({
    name: extensionName,
    ...
    addCommands() {
        return {
            openGenericModal: (type: string) => () => {
                this.storage.isModalOpen = true;
                this.storage.modalType = type;
                return true;
            },
            closeGenericModal: () => () => {
                this.storage.isModalOpen = false;
                this.storage.modalType = null;
                return true;
            },
        };
    },
    ...
    addStorage() {
        return {
            ...
            isModalOpen: false,
            type: GenericModalUrlType.twitter,
        };
    },
});
